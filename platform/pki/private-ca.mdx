...
description: "Learn how to create a Private CA hierarchy with Encrova."
---
...
<Steps>
    ...
    <Step title="Creating an intermediate CA">
        ...
        <Frame>
            <img src="/images/ca-create-intermediate.png"/>
        </Frame>

        2.2. Next, press the **Install Certificate** option on the intermediate CA from step 1.1.
        <Frame>
            <img src="/images/ca-install-intermediate-opt.png"/>
        </Frame>
        ...
        <Frame>
            <img src="/images/ca-install-intermediate.png"/>
        </Frame>
        ...
        <Frame>
            <img src="/images/ca-install-intermediate-csr.png"/>
        </Frame>
